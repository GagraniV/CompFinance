---
title: "Autoregressive Conditional Heteroskedasticity Models (ARCH) to Measure Volatility of Finacial Assests using R"
author: "Vijaya Gagrani (rexplore0@gmail.com & R Script @ https://github.com/GagraniV/CompFinance)"
date: "September 2015"
output:
...
log_pret<-diff(log(as.zoo(prices_mat[2:5])))/lag(log(as.zoo(prices_mat[2:5])),k=-1)*100
...
#The above two tests confirm that ARCH effect (no autocorrelation) exists in the monthly log return. Therefore we should employ the ARCH or GARCH volatility model.
...
plot(wfc_garch_11_fit,which="all")
...
Calculate 99% VaR assuming the standard normal distribution. The next period VaR at 99% is 0.50 With 99% probability; the daily gain or loss is above 50%
...
sim <- ugarchsim(wfc_garch_11_fit, n.sim = 1000, m.sim = 25, rseed = 1:25)
