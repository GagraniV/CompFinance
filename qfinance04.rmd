...
normalVaR(mu=c(mu_A, mu_B, mu_p1),
          ...
          w0=100000, tail_prob=0.05) 

### mean-variance efficient portfolios
---
Efficent portfolios have the highest expected return for a given level of risk.
Assumptions: Returns are covariance stationary and ergodic, jointly normally distrbuted means means, variances, and covariances of returns are constant over the investment horizon.
...
# Since the risk free rate fixed over the investment horizon. excess return over thr T-bills
 or risk premimum. Capital allocation line(CAL). The slope of CAl is called sharpe ration(SR).
r_f = 0.03
# T-bills + asset A
