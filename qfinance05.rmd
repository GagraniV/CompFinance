...
The stylized facts are statistical propertis which stays consitent over a time period for a type of a dataset. For example, for finacial returns often exhibits fat tails and the autocorrelation. 
The cross correlation matices(CCM) of a week stationary vector time sereis, the diagonal elements contains the autocorrrelation function, the off diagonal elements measures the concurrent linear relationship,
