...
The goal of this repositoy is to uexplore the econometric models and methods for the multiple return finacial time series known as the vector or multivariate time series analysis.
