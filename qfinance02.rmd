...
#why 999
#http://stackoverflow.com/questions/20846814/extract-time-in-getsymbols
B <- as.numeric(999)
muhat_boot<- rep(0, B)
nobs <- length(wfc_ret)
for (i in 1:B) {
...
wfc_mean_boot = boot(x=wfc_ret, statistic = mean_boot, R=999)
class(wfc_mean_boot)
names(wfc_mean_boot)
